...
function getAll(){
    ...
    if (isset($_GET['page_no']) && $_GET['page_no']!="") {
        ...
        $result_count = mysqli_query($conn,"SELECT COUNT(*) As total_records FROM `contactperson`");
        $total_records = mysqli_fetch_array($result_count);
        $total_records = $total_records['total_records'];
        $total_no_of_pages = ceil($total_records / $total_records_per_page);
        $second_last = $total_no_of_pages - 1; // total page minus 1
    
    $sql = "SELECT * FROM `contactperson` ORDER BY contact_id ASC LIMIT $offset, $total_records_per_page";
...
<tr class="w3-theme-l2">
              ...
              <a class="fa fa-eye" href="view.php?q=<?php echo $row["contact_id"]; ?>"></a>
              <a class="fa fa-pencil" href="edit.php?q=<?php echo $row["contact_id"]; ?>"></a>
